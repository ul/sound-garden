...
proc execute*(s: var seq[Signal], cmd: string) =
  ...
  of "circle": s &= s.word(circle, "circle")
  ...
  of "delay": s &= s.word(delay, "delay", 5*48000)
  of "sdelay": s &= s.word(smoothDelay, "sdelay", 32, 5*48000)
  of "ssdelay": s &= s.word(smoothestDelay, "ssdelay", 32, 5*48000)
  ...
  of "range", "[]": s &= s.word(basics.range, "range")
